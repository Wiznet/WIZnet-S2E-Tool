	...
	def __init__(self, log_level):
		...
		self.cmdset = { "MC" : ["MAC address", 
							 ...
							 "QP" : ["Remote Host Port number for channel 1",
							 			"^([0-9]|[1-9][0-9]{1,3}|[1-5][0-9]{4}|6[0-4][0-9][0-9][0-9]|65[0-4][0-9][0-9]|655[0-2][0-9]|6553[0-5])$",
							 			{}, "RW"],
							 "BR" : ["UART Baud rate for channel 0",
							 			"^([0-9]|1[0-3])$", 
							 			{"0" : "300", "1" : "600", "2" : "1200", "3" : "1800", "4" : "2400", "5" : "4800", "6" : "9600", "7" : "14400",
							 			 "8" : "19200", "9" : "28800", "10" : "38400", "11" : "57600", "12" : "115200", "13" : "230400"},
							 			"RW"],
							 "EB" : ["UART Baud rate for channel 1",
							 			"^([0-9]|1[0-3])$",
							 			{"0" : "300", "1" : "600", "2" : "1200", "3" : "1800", "4" : "2400", "5" : "4800", "6" : "9600", "7" : "14400",
							 			 "8" : "19200", "9" : "28800", "10" : "38400", "11" : "57600", "12" : "115200", "13" : "230400"},
							 			"RW"],
							 "DB" : ["UART Data bit length for channel 0", "^[0-1]$", {"0" : "7-bit", "1" : "8-bit"}, "RW"],
							 "ED" : ["UART Data bit length for channel 1", "^[0-1]$", {"0" : "7-bit", "1" : "8-bit"}, "RW"],
							 "PR" : ["UART Parity bit for channel 0", "^[0-2]$", {"0" : "NONE", "1" : "ODD", "2" : "EVEN"}, "RW"],
							 "EP" : ["UART Parity bit for channel 1", "^[0-2]$", {"0" : "NONE", "1" : "ODD", "2" : "EVEN"}, "RW"],
							 "SB" : ["UART Stop bit length for channel 0", "^[0-1]$", {"0" : "1-bit", "1" : "2-bit"}, "RW"],
							 "ES" : ["UART Stop bit length for channel 1", "^[0-1]$", {"0" : "1-bit", "1" : "2-bit"}, "RW"],
							 "FL" : ["UART Flow Control for channel 0", "^[0-2]$", {"0" : "NONE", "1" : "XON/XOFF", "2" : "RTS/CTS"}, "RW"],
							 "EF" : ["UART Flow Control for channel 1", "^[0-2]$", {"0" : "NONE", "1" : "XON/XOFF", "2" : "RTS/CTS"}, "RW"],
